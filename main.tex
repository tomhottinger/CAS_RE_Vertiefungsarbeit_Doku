...
%% general metadata:
\newcommand{\myauthor}{Thomas C. Hottinger}  %% also used for PDF metadata (hyperref)
\newcommand{\mytitle}{Bettenmanagement}  %% also used for PDF metadata (hyperref)
\newcommand{\mysubject}{Bettenmangement in einer Klinik}  %% also used for PDF metadata (hyperref)
\newcommand{\mykeywords}{KEYWORDS}  %% also used for PDF metadata (hyperref)

%% this information is used only for generating the title page:
\newcommand{\myworktitle}{CAS Vertiefungsarbeit}  %% official type of work like ``Master theses''
\newcommand{\mygrade}{Certificate of Advanced Studies} %% title you are getting with this work like ``Master of ...''
\newcommand{\mystudy}{Wirtschaftsinformatik} %% your study like ``Arts''
\newcommand{\myuniversity}{Fachhochschule Luzern} %% your university/school
\newcommand{\myinstitute}{Institute für HIEREINFüLLEN} %% affiliation
...
\newcommand{\myhomestreet}{Feldheim~32} %% your home street (with house number)
\newcommand{\myhometown}{Rothenburg} %% your home town
\newcommand{\myhomepostalnumber}{6023} %% your postal number of home town
